export const colors = {
  primary: '#1E3A5F', //Azul marinho - Fundo principal 
  secondary: '#5DADE2', // Azul claro - Botões, destaques
  background: '#F8F9FA', // Cinza claro - Fundo geral
  danger: '#E74C3C', // Vermelho - emergência
